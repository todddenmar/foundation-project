      ...
      <div className="sm:py-10">
        <ContainerLayout className={'px-0 sm:px-5'}>
          <div className="md:h-[600px] w-full bg-gradient-to-br from-red-300 to-highlight sm:rounded-[50px] flex flex-col justify-center items-center px-5 py-10 lg:p-10 transition-all duration-300">
            <div className="grid grid-cols-1 md:grid-cols-2 w-full md:px-10 xl:px-20 sm:gap-10">
              ...
              <div className="bg-white rounded-full w-[200px] sm:w-[300px] lg:w-[400px] transition-all duration-300 aspect-square mx-auto relative overflow-hidden">
                <Image
                  src={'/sample-images/sample-1.jpg'}
